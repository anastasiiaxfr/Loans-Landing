<template>
  <section class="section section_how-works" id="str">
    <div class="container">
      ...
      <div class="">
        <div class="row_2" v-for="(item, ind) in str" :key="ind">
          <div>
...
import img2 from "~/assets/img/img3.svg";
import img3 from "~/assets/img/img4.svg";
import img4 from "~/assets/img/img5.svg";
